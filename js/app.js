...
const EMBEDDED_DATA = {
  cities: [
    { city_id: 1, city_name: '延吉市', lon: 129.5088, lat: 42.8913,
      visitor_2025: 1100, visitor_2024: 1008, visitor_2023: 877.9, visitor_2022: 641, visitor_2021: 641 },
    { city_id: 2, city_name: '图们市', lon: 129.8439, lat: 42.9680,
      visitor_2025: 277, visitor_2024: 249, visitor_2023: 210, visitor_2022: 103.2, visitor_2021: 100.6 },
    { city_id: 3, city_name: '敦化市', lon: 128.2322, lat: 43.3728,
      visitor_2025: 759.93, visitor_2024: 820.6, visitor_2023: 692, visitor_2022: 385, visitor_2021: 385 },
    { city_id: 4, city_name: '珲春市', lon: 130.3660, lat: 42.8625,
      visitor_2025: 1064, visitor_2024: 800.36, visitor_2023: 557.7, visitor_2022: 190, visitor_2021: 271 },
    ...
    { city_id: 6, city_name: '和龙市', lon: 129.0108, lat: 42.5464,
      visitor_2025: 856.09, visitor_2024: 744.3, visitor_2023: 531, visitor_2022: 165, visitor_2021: 165 },
    { city_id: 7, city_name: '汪清县', lon: 129.7712, lat: 43.3128,
      visitor_2025: 120, visitor_2024: 116, visitor_2023: 98.3, visitor_2022: 25, visitor_2021: 24 },
    { city_id: 8, city_name: '安图县', lon: 128.8997, lat: 43.1116,
      visitor_2025: 1038.4, visitor_2024: 890, visitor_2023: 767, visitor_2022: 367, visitor_2021: 276 },
  ...
  modelParams: {
    1: { r: 0.8949, K: 1155.0, r2: 0.998, year80: 2023, hotness: 73.6 },
    2: { r: 0.5224, K: 381.2,  r2: 0.924, year80: null, hotness: 28.5 },
    3: { r: 1.5000, K: 824.1,  r2: 0.948, year80: 2023, hotness: 90.9 },
    4: { r: 0.3678, K: 8512.0, r2: 0.925, year80: 2035, hotness: 42.0 },
    5: { r: 0.8042, K: 529.6,  r2: 0.756, year80: null, hotness: 50.5 },
    6: { r: 1.5000, K: 915.1,  r2: 0.978, year80: 2024, hotness: 85.9 },
    7: { r: 1.0444, K: 134.4,  r2: 0.904, year80: null, hotness: 26.0 },
    8: { r: 0.7647, K: 1209.5, r2: 0.965, year80: 2026, hotness: 70.0 },
    9: { r: 0.0417, K: 3277.8, r2: 0.106, year80: null, hotness: 34.2 }
  },
...
function updateLeftPanel(cityId) {
  ...
  infoCard.innerHTML = `
    ...
    <div class="city-stats-row">
      <div class="city-stat">2025年游客<br/><strong>${city.visitor_2025}万</strong></div>
      <div class="city-stat">较2024年<br/><strong>${((city.visitor_2025/city.visitor_2024 - 1)*100).toFixed(1)}%</strong></div>
      <div class="city-stat">较2021年<br/><strong>${((city.visitor_2025/city.visitor_2021 - 1)*100).toFixed(1)}%</strong></div>
    </div>
  `;
...
function renderPredictionChart(city, params) {
  ...
  const histData = [
    city.visitor_2021, city.visitor_2022, city.visitor_2023,
    city.visitor_2024, city.visitor_2025
  ];

  // 使用已拟合的参数生成预测
  const t0 = 2021;
  const N0 = city.visitor_2021;
  const r = params.r;
  const K = params.K;

  // Logistic解析解生成拟合/预测曲线
  function logistic(t) {
    return K / (1 + (K/N0 - 1) * Math.exp(-r * (t - t0)));
  }
